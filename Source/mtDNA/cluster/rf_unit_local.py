from Source.mtDNA.cluster.rf_mt import rf_type_0_mt, rf_type_1_mt, rf_type_2_mt, rf_type_3_mt, rf_type_4_mt
from Source.mtDNA.cluster.rf_nuc import rf_type_0_nuc, rf_type_1_nuc, rf_type_2_nuc, rf_type_3_nuc, rf_type_4_nuc
...
def task_mt(config, results):
    ...
    elif int(config.params_dict['random_forest_type']) == 4:
        rf_type_4_mt(config, results)
...
def task_mt_nuc(config, results):
    if int(config.params_dict['random_forest_type']) == 0:
        ...
        rf_type_4_mt_nuc(config, results)
