...
from Source.mtDNA.tibet.functions.plot_functions import *
...
path = get_path()
data_path = path + '/Data/'
result_path = path + '/Result/isolated_with_haplogroups/'

if not os.path.exists(result_path):
    os.makedirs(result_path)

raw_data, subjects, data_classes = get_data(data_path)
haplogroups = get_subjects_haplogroups(data_path, subjects)

regions = get_regions(data_path)

mutated_positions = get_mutations_positions(data_path)
